...
def find_checkerboard_corners(image_path, checkerboard_size=(9, 6), debug_dir=None):
...
def calibrate_stereo(cam1_folder, cam2_folder, output_dir, 
                    checkerboard_size=(9, 7), square_size=26.0):
    """
    ...
    if successful_pairs > 0:
        try:
            ...
            ret, camera1_matrix, dist1, camera2_matrix, dist2, R, T, E, F = cv2.stereoCalibrate(
                ...
                img1_shape, criteria=criteria, flags=flags)
...
def main():
    ...
    square_size = 26.0  # mm (adjust this to your actual checkerboard)
