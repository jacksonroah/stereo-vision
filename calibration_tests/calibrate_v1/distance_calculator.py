...
def main():
    ...
    cam1_image = './camera1_calib_images/Almondi_frame_0000.png'  # Update with your image path
    cam2_image = './camera2_calib_images/Reyes_0002_frame_0000.png'  # Update with your image path
