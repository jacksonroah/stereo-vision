...
# CHECKERBOARD SQUARE SIZE V2 === 25.0 MM + 9x7 INTERNAL
def calibrate_single_camera(images_folder, checkerboard_size=(9,7), square_size=25.0):
    """
    ...
    # Add these flags to your cv2.calibrateCamera call:
